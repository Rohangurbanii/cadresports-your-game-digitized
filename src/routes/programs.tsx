...
function Programs() {
  ...
  return (
    <div>
      {/* HERO */}
      <section className="relative overflow-hidden pt-20 pb-24" ref={heroRef}>
      ...
      {/* LEAGUES */}
      <section className="relative py-24 lg:py-32" ref={leaguesRef}>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="space-y-20">
            {[
              ...
              <div key={league.title} className="scroll-slide-in-{i % 2 ? 'right' : 'left'} grid lg:grid-cols-2 gap-12 items-center">
      ...
      <section className="relative py-16 lg:py-20 bg-slate-50 border-y border-black/8">
        <div className="mx-auto max-w-7xl px-5 lg:px-8 text-center scroll-fade-in">
